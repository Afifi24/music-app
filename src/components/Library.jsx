...
const Library = ({songs,SelectAudio,setSongs,toggle}) => {
  return (
   <div>
       ...
       <div  className={` ${toggle ? '-translate-x-full duration-200':'translate-x-0 duration-200'} shadow-2xl fixed left-0 top-0 h-full w-full md:w-[22%] bg-white z-10 overflow-y-scroll `}>
